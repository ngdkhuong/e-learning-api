...
export const courseDbRepository = (repository: ReturnType<CourseRepositoryMongoDbInterface>) => {
    ...
    const getTrendingCourses = async () => await repository.getTrendingCourses();
    ...
    const getNumberOfCoursesAddedInEachMonth = async () => await repository.getNumberOfCoursesAddedInEachMonth();
