...
export const getDashBoardDetailsU = async (
    ...
    const [numberOfCourses, numberOfInstructors, numberOfStudents, monthlyRevenue] = await Promise.allSettled([
...
export const getGraphDetailsU = async (
    ...
    const [trendingCourses, courseByCategory, revenueForEachMonth, coursesAdded, coursesEnrolled] =
