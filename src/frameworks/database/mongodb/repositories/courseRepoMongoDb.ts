import { AddCourseInfoInterface, CourseInterface, EditCourseInfo } from '@src/types/courseInterface';
        ...
        const courses = await Course.aggregate([
            ...
            },
            {
                $project: {
                    ...
                    thumbnail: '$thumbnail',
                    instructorFirstName: {
                        $arrayElemAt: ['$instructor.firstName', 0],
                    },
                    instructorLastName: {
                        $arrayElemAt: ['$instructor.lastName', 0],
                    },
                    instructorProfile: {
                        $arrayElemAt: ['$instructor.profilePic', 0],
                    },
                    profilePic: '',
                },
            },
